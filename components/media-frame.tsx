...
export function MediaFrame({
  ...
  return (
    <div
      title={label}
      className={`absolute inset-0 flex flex-col items-center justify-center gap-xs bg-linear-to-br from-ink-deep via-[#12283a] to-[#0b3f7a] p-xl text-center ${className}`}
    >
